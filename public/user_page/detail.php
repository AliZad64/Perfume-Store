...
<?php } else{ ?> 
  <div class="stuff">
<div class="alert alert-warning alert-dismissible fade show" role="alert">
  <strong>Holy guacamole!</strong> product already there.
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>
...
<form method="POST" enctype="multipart/form-data"  action="/public/user_page/cartsession.php?id=<?php echo $product['id'] ?>" >
 <section class="py-5">
        <div class="container">
          <div class="row mb-5">
            <div class="col-lg-6">
              ...
              <div class="row m-sm-0">
                <div class="col-sm-10 order-1 order-sm-2">
                  <div class="owl-carousel product-slider" data-slider-id="1"><a class="d-block" href="img/product-detail-1.jpg" data-lightbox="product" title="Product item 1"><img class="img-fluid" src="../<?php echo $product['image'] ?>" alt="..."></a><a class="d-block" href="img/product-detail-2.jpg" data-lightbox="product" title="Product item 2"><img class="img-fluid" src="img/product-detail-2.jpg" alt="..."></a><a class="d-block" href="img/product-detail-3.jpg" data-lightbox="product" title="Product item 3"><img class="img-fluid" src="img/product-detail-3.jpg" alt="..."></a><a class="d-block" href="img/product-detail-4.jpg" data-lightbox="product" title="Product item 4"><img class="img-fluid" src="img/product-detail-4.jpg" alt="..."></a></div>
                </div>
              </div>
            </div>
            <!-- PRODUCT DETAILS-->
            <div class="col-lg-6">
              ...
              <p class="text-muted lead"> <span <?php if ($product['sale']){ echo 'style="text-decoration: line-through;"';}?>>
              <?php echo $product['price']?> </span>
               <?php echo '&nbsp; &nbsp; &nbsp;'.$product['sale'];?></p>
              <p class="text-small mb-4"><?php echo $product['description']?></p>
              <div class="row align-items-stretch mb-4">
                ...
                <div class="col-sm-3 pl-sm-0"><input type="submit" name="add_to_cart" class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" value="Add to cart"></div>
              ...
              <ul class="list-unstyled small d-inline-block">
                ...
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Brand:</strong><a class="reset-anchor ml-2" href="#">Demo Products</a></li>
              </ul>
            </div>
            ...
            <?php } else  { ?>
              <input type="hidden" name="hidden_price" value="<?php echo $product['sale']; ?>" />
              <?php } ?>
